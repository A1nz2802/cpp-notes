...
usuario un número entre (1-12), y mostrar el mes al que corresponde
*/
...
int main() {
  ...
  cout << "Ingrese un número entre 1-12: ";
  cin >> numero;
  ...
  switch( numero ) {
    ...
    default: cout << "No existe mes para ese número" << endl; break;
  }
